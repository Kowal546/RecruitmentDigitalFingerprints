...
#     # Wybierz punkt odniesienia (minimum) i utwórz listę różnic między kolejnymi elementami
#     print(snowflake)
#     differences = [j - i for i, j in zip(snowflake, snowflake[1:])]
#     print(differences)
#     min_index = differences.index(min(differences))
#     print(min_index)
#     # Obróć płatek tak, aby punkt odniesienia znalazł się na początku
#     normalized_snowflake = snowflake[min_index:] + snowflake[:min_index]
#     print(snowflake[min_index:])
#     print(snowflake[:min_index])
#     print(normalized_snowflake)
#     # Zwróć tuplę uzyskaną przez konwersję listy do tuple
#     print("yyyyyy")
#
#     return tuple(normalized_snowflake), tuple(normalized_snowflake[::-1])
#
# def find_identical_snowflakes(input_vectors):
#     snowflake_dict = {}
#
#     for i, snowflake in enumerate(input_vectors):
#         normalized_snowflake, normalized_snowflake_reverse = hash_snowflake(snowflake)
#
...
# ]
#
# output = find_identical_snowflakes(input_vectors)
# print(output)
